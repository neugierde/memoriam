...
class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taxonomy" do
    assert_difference('Taxonomy.count') do
      post taxonomies_url, params: { taxonomy: { name: @taxonomy.name, organization_id: @taxonomy.organization_id } }
    end
  ...
  test "should update taxonomy" do
    patch taxonomy_url(@taxonomy), params: { taxonomy: { name: @taxonomy.name, organization_id: @taxonomy.organization_id } }
